...
export default function UscisScreen({
  ...
  return (
    <div>
      <div style={{ position: "relative", display: "flex", alignItems: "center", minHeight: 40, marginBottom: 14 }}>
        <button
          onClick={onGoHome}
          style={{
            width: 40,
        ...
        <h2 style={{ position: "absolute", left: "50%", transform: "translateX(-50%)", fontSize: 20, fontWeight: 700, margin: 0, whiteSpace: "nowrap" }}>
          Справочник USCIS
        </h2>
      </div>
